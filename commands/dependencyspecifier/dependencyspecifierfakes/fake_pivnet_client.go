...
type FakePivnetClient struct {
	...
	DependencySpecifierStub        func(productSlug string, releaseID int, dependencySpecifierID int) (go_pivnet.DependencySpecifier, error)
...
func (fake *FakePivnetClient) DependencySpecifier(productSlug string, releaseID int, dependencySpecifierID int) (go_pivnet.DependencySpecifier, error) {
...
func (fake *FakePivnetClient) DependencySpecifierReturns(result1 go_pivnet.DependencySpecifier, result2 error) {
...
func (fake *FakePivnetClient) CreateDependencySpecifier(productSlug string, releaseID int, dependentProductSlug string, specifier string) (go_pivnet.DependencySpecifier, error) {
...
func (fake *FakePivnetClient) CreateDependencySpecifierReturns(result1 go_pivnet.DependencySpecifier, result2 error) {
