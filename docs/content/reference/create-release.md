# Create release (aliases: cr)

```
Usage:
  pivnet [OPTIONS] create-release [create-release-OPTIONS]
...
[create-release command options]
      ...
      -t, --release-type=        Release type e.g. 'Minor Release'
      -e, --eula-slug=           EULA slug e.g. pivotal_software_eula
