# Remove product file from release (aliases: rpf)

```
Usage:
  pivnet [OPTIONS] remove-product-file [remove-product-file-OPTIONS]
...
[remove-product-file command options]
      ...
      -f, --file-group-id=       File group ID e.g. 1234
